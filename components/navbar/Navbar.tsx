        ...
        <HStack bg="white" shadow={6}>
          <Pressable p="2" flex={1} onPress={() => handlePress(0)}>
            <Box
              rounded="lg"
              px="3"
              bg={selected === 0 ? 'purple.500' : 'white'}
            >
              <Center>
                <Text color={selected === 0 ? 'muted.50' : 'black'}>All</Text>
              </Center>
            </Box>
          </Pressable>
          <Pressable p="2" flex={1} onPress={() => handlePress(1)}>
            <Box
              rounded="lg"
              px="3"
              bg={selected === 1 ? 'purple.500' : 'white'}
            >
              <Center>
          ...
          <Pressable p="2" flex={1} onPress={() => handlePress(2)}>
            <Box
              rounded="lg"
              px="3"
              bg={selected === 2 ? 'purple.500' : 'white'}
            >
              <Center>
          ...
          <Pressable p="2" flex={1} onPress={() => handlePress(3)}>
            <Box
              rounded="lg"
              px="3"
              bg={selected === 3 ? 'purple.500' : 'white'}
            >
              <Center>
